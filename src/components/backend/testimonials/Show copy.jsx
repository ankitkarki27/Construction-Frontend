                        ...
                        <table className="w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr className="text-gray-700">
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Testimonial</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {testimonials.map((testimonial) => (
                                    <tr key={testimonial.id} className="hover:bg-gray-50 transition-colors duration-150">
                                        <td className="px-6 py-4 text-sm text-gray-700 font-mono">{testimonial.id}</td>
                                        <td className="px-6 py-4 text-sm font-medium text-gray-900">{testimonial.name}</td>
                                        <td className="px-6 py-4 text-sm text-gray-600">{testimonial.testimonial}</td>
                                        <td className="px-6 py-4 text-sm text-gray-600">{testimonial.phone}</td>
