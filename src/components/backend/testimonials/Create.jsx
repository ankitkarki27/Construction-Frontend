...
const Create = ({ setActiveSection }) => {
    ...
    return (
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mx-auto max-w-4xl mb-8">
              ...
              <h2 className="text-2xl font-semibold text-gray-800 mb-6">Create Testimonials</h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      {...register("name", { required: "Enter project title" })} 
                      type="text" 
                ...
                <div>
                  ...
                  <textarea 
                    {...register("testimonial", { required: "Enter a short testimonial" })} 
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" 
