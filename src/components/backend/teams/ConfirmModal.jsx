...
const ConfirmModal = ({ isOpen, onConfirm, onCancel, team }) => {
      ...
      >
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            Are you sure you want to remove the Team member named "<span className="font-medium text-gray-900">{team?.name}</span> designated as <span className="font-medium text-gray-900">{team?.designation}</span> "?
          </p>
