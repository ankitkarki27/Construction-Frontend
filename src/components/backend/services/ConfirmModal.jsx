...
const ConfirmModal = ({ isOpen, onConfirm, onCancel, service }) => {
      ...
      >
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            Are you sure you want to delete the service "<span className="font-medium text-gray-900">{service?.title}</span>"?
          </p>
