      ...
      <div className="space-y-6">
        <div className="bg-white p-6">
          <div className="flex items-center gap-4">
            <div className=" text-blue-600 p-6 rounded-lg shadow-md">
        ...
        <div className="bg-white p-6">
          <div className="flex items-center gap-4">
          <div className="text-blue-600 bg-white p-6 rounded-lg shadow-md">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-gray-600">info@rainbowconstructions.com</p>
            </div>
          </div>
        </div>
