      ...
      <div class="flex flex-wrap justify-between gap-10">
        <div class="max-w-md">
          <a href='javascript:void(0)'>
            <img src="/image.png" alt="logo" class='w-36' />
          </a>
          <div class="mt-6">
        ...
        <h4 class="text-gray-800 font-semibold text-base relative max-sm:cursor-pointer">Useful Links</h4>
          <ul class="space-y-4 mt-6">
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Home</a>
            </li>
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>About us</a>
            </li>
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Services</a>
            </li>
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Projects</a>
            </li>
          </ul>
...
<ul class="mt-6 space-y-4">
  <li>
    <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Concept Design</a>
  </li>
  <li>
    <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Interior Design</a>
  </li>
  <li>
    <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Architecture Design</a>
  </li>
  <li>
    <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Structure Design</a>
  </li>
</ul>
        </div>
        ...
        <div class="max-lg:min-w-[140px]">
          ...
          <ul class="space-y-4 mt-6">
            ...
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Blogs</a>
            </li>
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>Projects</a>
            </li>
      ...
      <div class="flex flex-wrap max-md:flex-col gap-4">
        ...
        <p class='text-gray-600 text-sm md:ml-auto'>© Rainbow Constructions. All rights reserved.</p>
      </div>
    </footer>
  );
};
