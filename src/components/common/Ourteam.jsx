  ...
  return (
    ...
    <div>
            <div class="max-w-2xl mx-auto text-center">
                ...
                <p class="text-gray-800 text-xl mt-4 leading-relaxed">Meet our team of professionals to serve you.</p>
            </div>
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8 text-center mt-16 max-w-5xl max-lg:max-w-3xl max-md:max-w-xl mx-auto">
                <div>
                    <img src="/hero.png" class="w-32 h-32 rounded-full inline-block" />
